            ...
            <div class="header__area-menubar">
                <div class="header__area-menubar-left">
                    <div class="header__area-menubar-left-logo">
                        <a href="{{route('home')}}"><img class="dark-n" src="assets/img/gof_logo.png" alt="image"></a>
                    </div>
                </div>
                    ...
                    <div class="header__area-menubar-right-box">
						...
						<div class="header__area-menubar-right-sidebar-popup">
                            ...
                            <div class="header__area-menubar-right-sidebar-popup-logo">
                                <a href="index.html"> <img src="assets/img/gof_logo.png" alt="image"> </a>
                            </div>
							...
							<div class="header__area-menubar-right-sidebar-popup-social">
								<ul>
									...
									<li><a href="https://twitter.com" target="_blank"><i class="fab fa-instagram"></i></a></li>
...
<div class="page__banner">
    <div class="page__banner-shape">
        {{-- <img src="@yield('bannerShapeImage')" alt="image"> --}}
    </div>
    <div class="container">
        <div class="row justify-content-between align-items-center">
            <div class="col-xl-6 col-lg-7">
                <div class="page__banner-content">
                    ...
                    <span><a href="@yield('breadcrumbHomeLink')">Home</a>
                        <span>|</span>
                        @yield('breadcrumbCurrent')
                    </span>
                </div>
            </div>
            <div class="col-xl-4 col-lg-5">
                <div class="page__banner-img">
                    <img src="@yield('bannerImage')" alt="image">
                </div>
            </div>
        </div>
    </div>
