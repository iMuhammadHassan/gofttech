    ...
    <div class="page-wrapper">
        <div class="content container-fluid">
            ...
            <div class="page-header">
                ...
                <div class="page-btn">
                    <a href="{{ route('finance.sale.add-sale') }}" class="btn btn-added">
                        <img src="{{ asset('assets/admin/img/icons/plus.svg') }}" class="me-2" alt="Add New Bank Icon">Add New Sale
                    </a>
                </div>
            </div>
                        ...
                        <div class="search-set">
                            <div class="search-path">
                                <a class="btn btn-filter" id="filter_search">
                                    ...
                                    <span><img src="{{ asset('assets/admin/img/icons/closes.svg') }}" alt="Close Icon"></span>
                                </a>
                            </div>
                                ...
                                <div class="col-lg-1 col-sm-6 col-12 ms-auto">
                                    <div class="form-group">
                                        <a class="btn btn-filters ms-auto">
                                            <img src="{{ asset('assets/admin/img/icons/search-whites.svg') }}" alt="Search Icon">
                                        </a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <table class="table datanew">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <a class="me-3" href="{{ route('finance.sale.edit-sale') }}">
                                            <img src="{{ asset('assets/admin/img/icons/edit.svg') }}" alt="Edit Icon">
                                        </a>
                                        <a class="me-3 confirm-text" href="javascript:void(0);">
                                            <img src="{{ asset('assets/admin/img/icons/delete.svg') }}" alt="Delete Icon">
                                        </a>
                                    </td>
                                </tr>
                                <tr>
