...
@section('content')
    <div class="page-wrapper">
        <div class="content">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('finance.proposal.store') }}" method="POST">
                        @csrf
                        <div class="row">
                            <!-- Lead Name -->
                            ...
                            <div class="col-lg-3 col-sm-6 col-12">
                                <div class="form-group">
                                    ...
                                    <div class="input-groupicon">
                                        <input type="text" name="valid_till" placeholder="Choose Date" class="datetimepicker">
                                        <div class="addonset">
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="customer_signature" placeholder="Enter Customer Signature">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="thank_you_note" placeholder="Enter Thank You Note">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label>
                                        <input type="checkbox" name="require_customer_signature" value="1">
