    ...
    <div class="page-wrapper">
        <div class="content container-fluid">
            ...
            <div class="page-header">
                ...
                <div class="page-btn">
                    <a href="{{ route('finance.invoice.add-invoice') }}" class="btn btn-added">
                        <img src="{{ asset('assets/admin/img/icons/plus.svg') }}" class="me-2" alt="Add New Invoice">Add New
                        Invoice
                    </a>
                </div>
            </div>
                            ...
                            <tbody>
                                @foreach ($invoices as $invoice)
                                    <tr>
                                        ...
                                        <td>
                                            <a class="me-3"
                                                href="{{ route('finance.invoice.edit-invoice', $invoice->id) }}">
                                                <img src="{{ asset('assets/admin/img/icons/edit.svg') }}" alt="Edit">
                                            </a>
                                            <a class="me-3"
                                                href="{{ route('finance.invoice.pdf-invoice', ['id' => $invoice->id]) }}">
                                                <img src="{{ asset('assets/admin/img/icons/eye.svg') }}" alt="View">
                                            </a>

                                            <form action="{{ route('finance.invoice.delete', $invoice->id) }}"
