    ...
    <div class="page-wrapper">
        <div class="content container-fluid">
            ...
            <div class="page-header">
                ...
                <div class="page-btn">
                    <a href="{{route('holiday.add-holiday')}}" class="btn btn-added">
                        <img src="{{ asset('assets/admin/img/icons/plus.svg') }}" class="me-2" alt="img">Add New Holiday
                    </a>
                </div>
            </div>
                        ...
                        <table class="table datanew">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <a class="me-3" href="{{ route('holiday.edit-holiday') }}">
