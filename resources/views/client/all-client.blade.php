    ...
    <div class="page-wrapper">
        <div class="content container-fluid">
            ...
            <div class="page-header">
                ...
                <div class="page-btn">
                    <a href="{{ route('client.add-client') }}" class="btn btn-added">
                ...
                <div class="card-body">
                    <div class="table-top">
                        ...
                        <div class="wordset">
                            <ul>
                                <li>
                                    <a href="{{ route('client.export-pdf') }}" data-bs-toggle="tooltip" data-bs-placement="top" title="PDF">
                                        <img src="{{ asset('assets/admin/img/icons/pdf.svg') }}" alt="pdf">
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('client.export-csv') }}" data-bs-toggle="tooltip" data-bs-placement="top" title="CSV">
